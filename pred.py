...
from Dino.dataset.labeled import RowImageDataset
...
def _parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="Dino/configs/CCD_vision_model_STD.yaml",
    ...
    parser.add_argument(
        "--test_root", type=str, default=None, help="path to test datasets"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--workdir", type=str, default=None, help="path to workdir folder"
    )
    parser.add_argument(
        "--subworkdir", type=str, default=None, help="optional prefix to workdir path"
    )
    parser.add_argument(
    ...
    # TODO config file
    args.config = "config/CCD_vision_model_STD.yaml"
...
def _get_databaunch(config):
    ...
    if config.dataset_scheme == "selfsupervised_kmeans":
        ...
        ds_kwargs["supervised_flag"] = (
            False
            if config.model_contrastive_supervised_flag is None
            else config.model_contrastive_supervised_flag
        )
    elif config.dataset_scheme == "supervised":
        dataset_class = RowImageDataset
    test_dataloaders = []
